...
CREATE TABLE SpotifyClone.history(
  ...
  PRIMARY KEY (`music_id`, `date`, `user_id`),
  CONSTRAINT FOREIGN KEY (`music_id`) REFERENCES music(`music_id`),
...
INSERT INTO SpotifyClone.user (`user_name`, `age`, `plan_id`, `assign_date`)
VALUES
...
INSERT INTO SpotifyClone.album(`release_year`, `name`, `artist_id`)
VALUES
  (1990, 'Envious', 1),
  (1993, 'Exuberant', 1),
  (1995, 'Hallowed Steam', 2),
  (1998, 'Incandescent', 3),
  (2001, 'Temporary Culture', 4),
  (2003, 'Library of liberty', 4),
  (2007, 'Chained Down', 5),
  (2012, 'Cabinet of fools', 5),
  (2015, 'No guarantees', 5),
  (2015, 'Apparatus', 6);

INSERT INTO SpotifyClone.music(`name`, `seconds`, `album_id`)
VALUES
  ('Soul For Us', 200, 1),
...
INSERT INTO SpotifyClone.history(`music_id`, `date`, `user_id`)
VALUES
